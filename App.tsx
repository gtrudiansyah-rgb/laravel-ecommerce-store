        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2 bg-gradient-to-r from-rose-500 to-red-600 px-3 py-1.5 rounded-lg shadow-lg shadow-rose-500/20">
              ...
              <span className="font-bold tracking-wider text-white text-lg">ArtisanStore</span>
            </div>
              ...
              <div className="bg-slate-800/70 border border-slate-700/60 p-6 rounded-2xl space-y-4 lg:col-span-1">
                ...
                <div className="pt-4 border-t border-slate-700">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3.5 py-2 text-sm text-emerald-400 font-mono focus:ring-2 focus:ring-rose-500 focus:outline-none"
                  />
